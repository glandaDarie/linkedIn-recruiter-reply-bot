...
class Message_controller:
    ...
    def fetch_all_chat_history(self, pixels_batch : int = 300) -> List[List[str]]:
        """
        Fetch the entire chat history from the messages page.
        ...
        try:
            ...
            for message_li in messages_li:
                ...
                if class_name == "msg-s-message-list__event clearfix":
                    result : Tuple[str] | Exception = self.get_senders_name_and_message(message_li)
    ...
    def get_senders_name_and_message(self, message_li : object) -> Tuple[str] | Exception:
        """
